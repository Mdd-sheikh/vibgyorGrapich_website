...
export const whyChooseMe = [
  {
    ...
    description: "Extensive experience creating designs for global brands and local businesses across diverse industries.",
    icon: "Award"
  },
  {
    title: "Fast Turnaround",
    description: "Quick delivery without compromising quality. Most projects completed within agreed timelines or faster.",
    icon: "Zap"
  },
  {
    title: "Unlimited Revisions",
    description: "Your satisfaction is priority. I'll work with you until the design perfectly matches your vision.",
    icon: "RefreshCw"
  },
  {
    title: "Print-Ready Files",
    description: "All designs delivered with professional specifications, ready for immediate production.",
    icon: "FileCheck"
  },
  {
    title: "Creative Excellence",
    description: "Award-winning designs that not only look stunning but drive real business results.",
    icon: "Sparkles"
  },
  {
    title: "24/7 Support",
    description: "Available for consultations and support throughout the project lifecycle and beyond.",
    icon: "Headphones"
  }
];
